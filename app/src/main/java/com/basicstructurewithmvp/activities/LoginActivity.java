 ...
 * Created by Paresh
 */
public class LoginActivity extends MVPActivity<LoginPresenter, LoginView>
    ...
    private void callLoginApi() {
        ...
        params.put(ApiParamConstants.EMAIL, AppUtils.getText(etEmail));
        params.put(ApiParamConstants.PASSWORD, AppUtils.getText(etPassword));
        params.put(ApiParamConstants.DEVICE_TYPE, String.valueOf(AppConstants.DEVICE_TYPE));
